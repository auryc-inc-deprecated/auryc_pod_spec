...
Pod::Spec.new do |s|
  ...
  s.author             = { "Anuj Bhatnagar" => "bonjour.anuj@gmail.com" }
  # Or just: s.author    = "Anuj Bhatnagar"
  # s.authors            = { "Anuj Bhatnagar" => "bonjour.anuj@gmail.com" }
  # s.social_media_url   = "http://twitter.com/em_anuj"
  ...
  s.source = {
    :http => 'https://s3.amazonaws.com/auryc.sdk/prod/Auryc.framework_xcode9.2_bitcode_masking3.zip'
  }
